...
export class DecisionPage implements OnInit {
  ...
  public getText(){
    if(this.iterator===0){
      this.textts = 'Welcome engineer, I am chief engineer. Seems like you are one of the best in your field and also NASAs new hire.';
    }
      ...
      this.textts = 'Before we start, what is your name engineer?';
      this.condition=2;
    }
      ...
      this.textts='Interesting idea '+ this.name + ' .There is a few considerations I would like you to make:';
      this.condition = 0;
    }
